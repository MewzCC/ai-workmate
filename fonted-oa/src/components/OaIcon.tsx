...
export const oaKnowledgeBaseIconOptions: Array<{ value: OaIconName; label: string }> = [
  { value: 'knowledge-base', label: '知识库' },
  { value: 'book', label: '书籍' },
  { value: 'read', label: '阅读' },
  { value: 'file', label: '文件' },
  { value: 'file-text', label: '文档' },
  { value: 'file-image', label: '图片' },
  { value: 'folder', label: '文件夹' },
  { value: 'folder-open', label: '文件夹(展开)' },
  { value: 'profile', label: '档案' },
  { value: 'snippets', label: '片段' },
  { value: 'tags', label: '标签' },
  { value: 'star', label: '收藏' },
  { value: 'cloud', label: '云盘' },
  { value: 'global', label: '网络' },
  ...
  { value: 'robot', label: '智能助手' },
  { value: 'thunderbolt', label: '闪电' },
  { value: 'aim', label: '目标' },
  { value: 'eye', label: '预览' },
  { value: 'tool', label: '工具' },
