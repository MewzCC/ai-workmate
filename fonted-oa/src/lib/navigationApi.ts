...
export interface NavigationRoute {
  ...
  componentKey?: 'DASHBOARD' | 'AI_WORKSPACE' | 'ACCESS_CONTROL' | 'WORKBENCH_MODULE' | 'DICTIONARY' | 'TENANT_CONFIG' | 'DATA_PERMISSION' | 'AI_PERMISSION' | 'SUPPLIER' | 'CONTRACT' | 'EXPENSE' | 'BUDGET'
    | 'AI_TASK_CENTER'
