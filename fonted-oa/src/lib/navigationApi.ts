...
export interface NavigationRoute {
  ...
  componentKey?: 'DASHBOARD' | 'AI_WORKSPACE' | 'ACCESS_CONTROL' | 'WORKBENCH_MODULE' | 'DICTIONARY' | 'TENANT_CONFIG' | 'DATA_PERMISSION' | 'AI_PERMISSION' | 'SUPPLIER' | 'CONTRACT' | 'EXPENSE' | 'BUDGET' | 'API_CENTER' | 'PAGE_ACTIONS' | 'RUNTIME_LOGS'
    | 'AI_TASK_CENTER'
