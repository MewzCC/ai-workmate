...
public enum ErrorCode {
    ...
    AUTH_CODE_INVALID(40011, "AUTH_CODE_INVALID", HttpStatus.BAD_REQUEST, "验证码错误"),
    AUTH_CODE_EXPIRED(40012, "AUTH_CODE_EXPIRED", HttpStatus.BAD_REQUEST, "验证码已过期"),
    AUTH_CAPTCHA_REQUIRED(40013, "AUTH_CAPTCHA_REQUIRED", HttpStatus.BAD_REQUEST, "请先完成图形验证码"),
    AUTH_ACCOUNT_LOCKED(42301, "AUTH_ACCOUNT_LOCKED", HttpStatus.LOCKED, "登录尝试过多，账号已临时锁定"),
    ...
    RESOURCE_NOT_FOUND(40401, "RESOURCE_NOT_FOUND", HttpStatus.NOT_FOUND, "资源不存在"),
