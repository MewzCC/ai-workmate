...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleMalformedRequest(Exception ex) {
        return Result.error(ErrorCode.REQUEST_INVALID);
    }
    ...
    public ResponseEntity<Result<Void>> handleIdempotencyConflict(IdempotencyConflictException ex) {
        return ResponseEntity.status(ErrorCode.IDEMPOTENCY_CONFLICT.getStatus())
                .body(Result.error(ErrorCode.IDEMPOTENCY_CONFLICT));
    }
