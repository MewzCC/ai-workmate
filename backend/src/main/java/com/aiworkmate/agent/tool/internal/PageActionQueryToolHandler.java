...
public final class PageActionQueryToolHandler extends TypedReadToolHandler<PlatformOperationsToolPort.PageActionQuery, PlatformOperationsToolPort.Page<PlatformOperationsToolPort.PageAction>> {
    ...
    @Override protected PlatformOperationsToolPort.PageActionQuery parseArguments(JsonNode a) { return new PlatformOperationsToolPort.PageActionQuery(optionalText(a, "targetPageId"), optionalBoolean(a, "enabled"), positiveInt(a, "page", 1, 10000), positiveInt(a, "size", 20, 50)); }
