...
public final class SandboxReplayQueryToolHandler extends TypedReadToolHandler<PlatformOperationsToolPort.ReplayQuery, PlatformOperationsToolPort.Page<PlatformOperationsToolPort.Replay>> {
    ...
    @Override protected PlatformOperationsToolPort.ReplayQuery parseArguments(JsonNode a) { return new PlatformOperationsToolPort.ReplayQuery(optionalPositiveLong(a, "replayId"), optionalText(a, "keyword"), optionalText(a, "status"), pageNumber(a), pageSize(a)); }
