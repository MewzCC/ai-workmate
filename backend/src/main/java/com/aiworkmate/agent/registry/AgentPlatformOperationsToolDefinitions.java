...
public class AgentPlatformOperationsToolDefinitions {
    ...
    private ToolDefinition definition(ToolCode code, String name, String description, String permission, String input, String output, ObjectMapper m) throws JsonProcessingException { return ToolDefinitionFactory.read(code, name, description, "Display an authorized platform operations summary.", m.readTree(input), m.readTree(output), Set.of(permission), OwnershipPolicy.TENANT_SCOPED, 50, 196608, 15000); }
